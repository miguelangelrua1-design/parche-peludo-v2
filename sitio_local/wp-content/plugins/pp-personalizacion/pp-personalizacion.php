		...
		<div style="display:flex;gap:20px;flex-wrap:wrap;margin-top:18px">
			...
			<div style="flex:1;min-width:260px;max-width:360px;background:#fff;border:1px solid #dcdcde;border-radius:12px;padding:20px">
				...
				<ul style="margin:0;color:#50575e">
					...
					<li>Dirección al reservar (Depto → Ciudad → Dirección) y en Mi Perfil</li>
				</ul>
...
require_once PP_PERS_DIR . 'includes/servicios-vitrina.php';
require_once PP_PERS_DIR . 'includes/form-publicacion.php';
require_once PP_PERS_DIR . 'includes/buscador.php';
